# How to Manage Your Notes

Your notes are end-to-end encrypted. Only your devices can read them.
...
2. Tap or click **New note**.
3. The cursor starts in the title. Type a title, then write the body in Markdown (or plain text).
4. Changes save automatically after a short pause, when you switch notes, and when you leave the page. The note is encrypted on your device and synced.
...
Open the note, select **Delete** in the row below the title, and confirm. The deletion syncs to your other devices.
