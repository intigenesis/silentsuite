...
const files = ['contracts/annual-only-public-review-v2.schema.json', 'contracts/annual-only-public-disclosure-v2.schema.json', 'contracts/annual-only-billing-v2.schema.json', 'contracts/annual-only-billing-v2.schema.sha256']
